    ...
    [1280], {
        ...
        797163: (e, t, n) => {
            ...
            t.default = function (e) {
                ...
                i = e;
                const [t, o, s] = e === l.EMOJI_TYPE.APPLE ? [(0, a.default)(n(28193)), (0, a.default)(n(23424)), (0, a.default)(n(639154))] : [(0, a.default)(n(568412)), (0, a.default)(n(846355)), (0, a.default)(n(738779))];
        ...
        268755: (e, t, n) => {
            ...
            function a (e) {
                ...
                return (0, l.toProductionString)(r.default.accentFold((t = e.toLocaleLowerCase("en")) === null || t === undefined ? undefined : t.normalize("NFKD"))).split(" ");
            }
        },
        965858: (e, t) => {
            "use strict";
        ...
        339703: (e, t, n) => {
            ...
            const d = (0, o.defineEvents)({
                ChatFilterEvent: [1616, {
                        ...
                        filterType: [2, a.CHAT_FILTER_TYPES],
                        metadata: [7, u],
                        searchQueryId: [8, u],
                        searchRequestId: [9, u],
                        searchResultType: [4, i.CHAT_SEARCH_RESULT_TYPE],
                        sessionId: [3, s],
                        targetScreen: [5, l.CHAT_FILTER_TARGET_SCREEN]
                    },
                    [1, 1, 1], "regular"
                ]
            });
        ...
        923949: (e, t, n) => {
            ...
            const i = (0, o.defineEvents)({
                UiMessageYourselfAction: [3780, {
                        uiMessageYourselfActionSessionId: [1, a],
                        uiMessageYourselfActionType: [2, r.UI_MESSAGE_YOURSELF_ACTION_TYPE],
                        uiMessageYourselfFunnelName: [3, l.UI_MESSAGE_YOURSELF_FUNNEL_NAME]
                    },
                    [1, 1, 1], "regular"
                ]
            });
        ...
        165433: (e, t, n) => {
            ...
            class s {
                ...
                _commitAction (e) {
                    new l.UiMessageYourselfActionWamEvent({
                ...
                newChatPressed () {
                    this._commitAction(a.UI_MESSAGE_YOURSELF_ACTION_TYPE.NEW_CHAT_PRESSED);
                }
                youSelected () {
                    this._commitAction(a.UI_MESSAGE_YOURSELF_ACTION_TYPE.YOU_SELECTED);
                }
                searchBarPressed () {
                    this._commitAction(a.UI_MESSAGE_YOURSELF_ACTION_TYPE.SEARCH_BAR_PRESSED);
                }
                ...
                searchFullNameYouSelected () {
                    this._commitAction(a.UI_MESSAGE_YOURSELF_ACTION_TYPE.SEARCH_FULL_NAME_YOU_SELECTED);
                }
                newMessageYourselfCreated () {
                    this._commitAction(a.UI_MESSAGE_YOURSELF_ACTION_TYPE.NEW_NTS_CREATED);
                }
                existingMessageYourselfOpened () {
                    this._commitAction(a.UI_MESSAGE_YOURSELF_ACTION_TYPE.EXISTING_NTS_OPENED);
                }
            }
        ...
        409623: (e, t, n) => {
            ...
            function te (e) {
                ...
                n.push(z.default.createElement(ee, {
                    ...
                    icon: z.default.createElement(b.GroupIcon, {
                        iconXstyle: Q.icon
                    }),
            ...
            function ne (e) {
                ...
                const n = v.LabelCollection.toArray().reduce((e, n) => n.name && n.count && n.count !== 0 ? [...e, z.default.createElement(g.DropdownItem, {
            ...
            function le (e, t) {
                ...
                const be = Boolean(Ne || me);
                const ve = ge || ce || be && !y && !Q;
                const ye = () => {
                    const e = se.current;
                    if (e && !_e) {
                        e.reset();
                ...
                const Ae = e => {
                    ...
                    if (b) {
                        (0, T.logSelectFilterEvent)(b.sessionId, e);
                    }
                    E(ce, e);
                };
                const xe = () => {
                    (0, l.default)(se.current, "inputRef.current").focus();
                    Ce(true);
                };
                const Re = e => {
                    if (b) {
                        (0, T.logOpenFilterEvent)(b.newSessionId());
                    }
                    e.stopPropagation();
                    Te({
                ...
                const Le = () => (0, l.default)(se.current, "inputRef.current").isCursorAtEnd();
                const we = () => {
                    (0, l.default)(se.current, "inputRef.current").selectAll();
                };
                const Ie = () => {
                    Ae({
                        kind: null,
                ...
                const je = (0, m.classnamesConvertMeToStylexPlease)({
                    [c.default.active]: ve && g !== J.SELECT_DROPDOWN_SEARCH,
                ...
                const Be = !ce && (S || !ge || be || A === d.default.CommandPalette);
                let He = null;
                if (Be) {
                    He = o;
                    if (A === d.default.CommandPalette) {
                        ...
                        He = W.fbt._("Search in {labelName}...", [W.fbt._param("labelName", v.LabelCollection.assertGet(me).name)], {
                            hk: "JMLBG"
                        });
                ...
                }, z.default.createElement(a.BackIcon, null)), Ue) : z.default.createElement("div", {
            ...
            const ae = (0, z.forwardRef)(le);
            t.ListSearch = ae;
            ae.displayName = "ListSearch";
        },
        638938: (e, t, n) => {
            "use strict";
        ...
        170206: (e, t, n) => {
            ...
            const m = (0, s.forwardRef)((e, t) => {
                ...
                const V = (0, a.classnamesConvertMeToStylexPlease)(o, l.default.chat, {
                    [l.default.chatInteractive]: U,
                    [l.default.cartProduct]: f === "cart-product",
                    [l.default.themeCheckbox]: v || f === "chat-checkbox" || f === "chat-checkbox-no-delete" || f === "cell-message-checkbox" || f === "chat-checkbox-disabled",
                    [l.default.themeDrawerList]: f === "drawer-list" || f === "chat-info" || f === "label-list" || f === "label-list-new-label" || f === "label-list-no-border" || f === "subgroup" || f === "subgroup-new" || f === "quick-replies-drawer-item",
                    [l.default.themeChatInfo]: f === "chat-info",
                    [l.default.themeSubgroup]: f === "subgroup" || f === "subgroup-new",
                    [l.default.themeSubgroupNew]: f === "subgroup-new",
                    [l.default.themeCommunityHome]: f === "community-home",
                    [l.default.themeIdentity]: f === "identity",
                    [l.default.themeListNames]: f === "list-names" || f === "list-names-no-delete",
                    [l.default.themeMessage]: f === "cell-message" || f === "cell-message-checkbox",
                    [l.default.themePlain]: f === "plain",
                    [l.default.themeSearch]: f === "chat-search",
                    [l.default.themeStatusListModal]: f === "status-list-modal",
                    [l.default.themeLabel]: f === "label-selection",
                    [l.default.themeNewLabel]: f === "label-list-new-label",
                    [l.default.themeAddItem]: f === "add-item",
                    [l.default.themeAddItemPlaceholder]: f === "add-item-placeholder",
                    [l.default.themeAddOrderItem]: f === "add-order-item",
                    [l.default.idle]: m,
                    [l.default.member]: f === "group-modal" || f === "chat-checkbox-no-delete",
                    [l.default.unread]: !!b,
                    [l.default.chatDrag]: !!O,
                    [l.default.active]: K || !!y,
                    [l.default.isMuted]: !!A,
                    [l.default.groupsV4Invite]: f === "groups_v4_invite",
                    [l.default.product]: f === "product" || f === "product-out-of-stock" || f === "product-of-collection" || f === "collection-header" || f === "collection-edit",
                    [l.default.productOfCollection]: f === "product-of-collection",
                    [l.default.productOutOfStock]: f === "product-out-of-stock",
                    [l.default.collectionEdit]: f === "collection-edit",
                    [l.default.collectionHeader]: f === "collection-header",
                    [l.default.orderProduct]: f === "order-product",
                    [l.default.media]: f === "media",
                    [l.default.listButton]: f === "list-button-compact",
                    [l.default.listMsg]: f === "list-msg",
                    [l.default.archivePanel]: f === "archive-panel",
                    [l.default.themeRadioButtonRow]: f === "radio-button-row",
                    [l.default.stickerPack]: f === "sticker-pack",
                    [l.default.themeReaction]: f === "reaction-by-others" || f === "reaction-by-me" || f === "newsletter-reaction-by-others" || f === "newsletter-reaction-by-me",
                    [l.default.themeReactionByMe]: f === "reaction-by-me",
                    [l.default.themeNewsletterLinkDrawer]: f === "newsletter-link-cell",
                    [l.default.themeReactionByOthers]: f === "reaction-by-others",
                    [l.default.themeNewsletterReactionByOthers]: f === "newsletter-reaction-by-others",
                    [l.default.themeNewsletterContactReactions]: f === "newsletter-reaction-by-contact",
                    [l.default.disabled]: f === "disabled",
                    [l.default.linkedAccount]: f === "linked-account" || f === "linked-account-consumer",
                    [l.default.linkedAccountConsumer]: f === "linked-account-consumer",
                    [l.default.themeCheckboxDisabled]: f === "chat-checkbox-disabled",
                    [l.default.themeCommunityTabHome]: f === "community-tab-home" || f === "community-tab-home-new",
                    [l.default.themeCommunityTabHomeNew]: f === "community-tab-home-new",
                    [l.default.themeCommunityTabSubgroup]: f === "community-tab-subgroup",
                    [l.default.themeCommunityTabViewAll]: f === "community-tab-view-all",
                    [l.default.themeCommunityTabActivityCell]: f === "community-tab-activity-cell",
                    [l.default.themeCommunityCreate]: f === "community-create",
                    [l.default.themeNoBorder]: f === "no-border" || f === "label-list-new-label" || f === "label-list-no-border",
                    [l.default.themeProductAddToOrder]: f === "product-add-to-order",
                    [l.default.themeSelectDropdownItem]: f === "select-dropdown-item",
                    [l.default.tallerCellWithLabel]: g != null,
                    [l.default.chatMaterial]: (0, i.supportsMaterialDesign)(),
                    [l.default.noBorderMaterial]: (0, i.supportsMaterialDesign)()
                });
                let X;
                if (p) {
                ...
                const Q = _ != null ? s.default.createElement("div", {
                    className: (0, a.classnamesConvertMeToStylexPlease)({
                        [l.default.chatMeta]: !["product", "product-out-of-stock", "product-of-collection"].includes(f) && f !== "sticker-pack"
                    })
                }, _) : null;
                let J;
                let Z;
                if (T != null) {
                    ...
                    J = s.default.createElement("div", {
                        ...
                        className: (0, a.classnamesConvertMeToStylexPlease)(l.default.chatStatus, {
                            [l.default.extendSecondaryEllipsis]: N
                        })
                    }, T), g == null && Z);
                }
                const ee = E != null ? s.default.createElement("div", {
                    className: (0, a.classnamesConvertMeToStylexPlease)(l.default.chatBody, l.default.chatDetails, {
                        [l.default.noBorderMaterial]: (0, i.supportsMaterialDesign)()
                    })
                }, E) : null;
                return s.default.createElement("div", (0, r.default)({
                    ...
                    className: (0, a.classnamesConvertMeToStylexPlease)(l.default.chatBody, {
                        [l.default.noBorderMaterial]: (0, i.supportsMaterialDesign)()
                    })
                    ...
                    role: k,
                    "aria-colindex": j,
                    className: (0, a.classnamesConvertMeToStylexPlease)(l.default.chatMain, {
                        [l.default.noDelete]: f === "list-names-no-delete"
                    })
                }, s.default.createElement("div", {
            ...
            t.default = class {
                ...
                _getText(e) {
                    ...
                    return (0, r.default)(function* () {
                        ...
                        const l = Promise.all(r.map(e => new Promise(t => e.getAsString(t))));
                        return (yield l).find(e => e.length);
                    })();
                }
                getFiles() {
                    if (this.data.items) {
                    ...
                    const i = o.then(() => new Promise((n, o) => {
                        const i = (0, r.default)((0, r.default)({}, t), {}, {
                            ...
                            inactive: () => {
                                ...
                                o((0, l.default)(`Failed to load font: ${u.getName(e)}`));
                            }
                        });
                        a.default.load(i);
                    }));
        ...
        80301: (e, t, n) => {
            ...
            function P (e, t) {
                ...
                const v = T ? T.primary : (0, l.default)(u, "defaultLabel");
                const M = T && f === true ? N.default.createElement("span", {
                    className: (0, b.default)(C.uiMargin.end12)
                }, T.image) : null;
                ...
                return N.default.createElement(g.UIE, {
                    ...
                    className: (0, b.default)(R.selectDropdownContainer)
                    ...
                    className: (0, b.default)(R.select, M != null && R.selectWithImageLabel, C.uiPadding.start24, C.uiPadding.end36, (k || x) && R.selectFocused)
                }), M, N.default.createElement(_.WDSTextTitle, {
                    as: "span"
                }, v), N.default.createElement(a.CaretDownIcon, {
                    xstyle: R.caretIcon
            ...
            function w (e) {
                ...
                return N.default.createElement(g.UIE, {
                    ...
                    className: (0, b.default)(R.dropdownMenu)
                    ...
                    active: E.current,
                    onSelect: r,
                    testIdPrefix: a != null ? a : "select-dropdown"
                })))));
            }
            ...
            function I (e) {
                ...
                return N.default.createElement("div", {
                    ...
                    className: (0, b.default)(R.dropdownMenuOption, C.uiPadding.horiz24, C.uiPadding.vert12),
        ...
        137506: (e, t, n) => {
            ...
            t.Switch = function (e) {
                ...
                return a.default.createElement(r.HotKeys, {
                    handlers: {
                        enter: C
                    }
                    ...
                    role: "switch",
                    tabIndex: o != null ? o : 0,
                    "aria-label": m != null ? m : l.fbt._("Toggle setting", null, {
                        hk: "KwvAU"
                    }),
                    id: d
        ...
        465113: (e, t, n) => {
            ...
            t.scrollAt = function (e, t) {
                ...
                const a = n.duration != null && n.duration !== 0 ? n.duration : 1000;
                const s = n.offset || 0;
                switch (r) {
                    case "top":
            ...
            t.scrollIntoView = function (e) {
                ...
                const l = parseInt(r.getPropertyValue("border-top-width"), 10);
                const a = e.offsetTop - o.offsetTop < o.scrollTop;
                const s = e.offsetTop - o.offsetTop + e.clientHeight - l > o.scrollTop + o.clientHeight;
                if (t) {
                    o.scrollTop = e.offsetTop - o.offsetTop - o.clientHeight / 2 - l + e.clientHeight / 2;
                } else {
                    e.scrollIntoView(a && !s);
                }
                return !(a || s);
            };
            t.scrollIntoViewIfNeeded = function (e) {
                ...
                const a = parseInt(l.getPropertyValue("border-top-width"), 10);
                const s = e.offsetTop - o.offsetTop < o.scrollTop;
                const u = e.offsetTop - o.offsetTop + e.clientHeight - a > o.scrollTop + o.clientHeight;
                if ((s || u) && t) {
            ...
            function i (e) {
                ...
                throw (0, a.default)("utils:DOM parent not defined or is not a valid HTMLElement");
            }
        },
        251922: (e, t, n) => {
            "use strict";
            ...
            t.$insertText = function (e, t) {
                ...
                const l = (n = c()) !== null && n !== undefined ? n : (0, r.$getRoot)().selectEnd();
                const a = (0, r.$createTextNode)(e);
                l.insertNodes([a]);
                if (o) {
                    d(a);
                }
            ...
            t.selectAll = function (e) {
                ...
                e.update(() => {
                    const e = c();
                    if (e) {
                        if (!(l.$selectAll === null || l.$selectAll === undefined)) {
                            (0, l.$selectAll)(e);
                        }
                    }
                });
            ...
            function p (e, t) {
                ...
                for (let e = 0; e < o.length; e++) {
                    ...
                    const t = (0, a.default)(n.getLastChild(), "root.getLastChild<ParagraphNode>()");
                    const l = new r.TextNode(o[e]);
                    t.append(l);
                }
                if (t) {
                    n.selectEnd();
        ...
        150610: (e, t, n) => {
            ...
            const Q = (0, F.forwardRef)((e, t) => {
                    ...
                    return {
                        ...
                        paste (e) {
                            ...
                            if (t instanceof ClipboardEvent) {
                                if (!(Te == null)) {
                                    Te.dispatchCommand(a.PASTE_COMMAND, t);
                                }
                            }
                        },
                        editor: Te,
                ...
                (0, H.useLexicalCommandListener)(Te, a.FOCUS_COMMAND, () => false);
                const Me = (0, F.useMemo)(() => ({
                    namespace: "WAWebRichTextInput",
                    theme: X,
                    nodes: [b.EmojiNode, A.MentionNode, M.ListBulletNode, O.ListNumberNode, w.QuoteLineNode, f.BidiParagraphNode, C.DelimiterNode, {
                        replace: a.ParagraphNode,
                ...
                return F.default.createElement("div", {
                    ...
                    selectAll: he
                }), F.default.createElement(v.EmojisPlugin, {
                    emojiSize: ge
        ...
        654761: (e, t, n) => {
            ...
            t.Placeholder = function (e) {
                ...
                return a.default.createElement("div", {
                    testid: o,
                    className: (0, i.default)(f.container, l.isOSMac && f.fontSmoothing, n)
                }, t);
            };
            var r = n(71671);
            var l = n(572946);
        ...
        16188: (e, t, n) => {
            ...
            t.useLexicalCommandListener = function (e, t, n) {
                ...
                (0, l.useEffect)(() => {
                    if (e) {
                        return e.registerCommand(t, a, o);
                    }
                }, [e, t, a, o]);
            };
            t.useLexicalKeydownEvent = function (e, t, n, o) {
                (0, a.useListener)(e && e.getRootElement(), "keydown", o => {
                    if (!(!e || t != null && o.key !== t)) {
                        n(o, e);
                    }
                }, {
            ...
            class c extends r.ParagraphNode {
                ...
                updateDOMMargin(e) {
                    ...
                    if (o) {
                        ...
                        const a = (l == null ? undefined : l.getBulletNode()) || (l == null ? undefined : l.getNumberNode());
                        if (!(a && a.getType() === o.getType())) {
                            n = 4;
                        }
                    }
                    if (this.getQuoteLineNode()) {
        ...
        616098: (e, t, n) => {
            ...
            class i extends r.TextNode {
                ...
                static importJSON() {
                    throw (0, a.default)("Deserialization of DelimiterNode is unsupported");
                }
                createDOM(e) {
                    const t = super.createDOM(e);
                    t.className = (0, l.classnamesConvertMeToStylexPlease)(t.className, "jv8stmnn");
                    return t;
                }
                exportJSON() {
                    throw (0, a.default)("Serialization of DelimiterNode is unsupported");
                }
            }
            ...
            class f extends r.TextNode {
                ...
                createDOM() {
                    ...
                    switch (this.__emojiSize) {
                        case d.Small:
                            f = a.EmojiUtil.getGlyphPath(e, 40);
                            break;
                        case d.Medium:
                            f = a.EmojiUtil.getGlyphPath(e, 64);
                            s = c.emojiMedium;
                            break;
                        case d.Large:
                            f = a.EmojiUtil.getGlyphPath(e, 64);
                    ...
                    t.className = (0, l.classnamesConvertMeToStylexPlease)(t.className, (0, u.default)(c.emoji, n, o, r, s));
                    if (f != null) {
        ...
        330007: (e, t, n) => {
            ...
            class s extends r.TextNode {
                ...
                createDOM(e) {
                    const t = super.createDOM(e);
                    t.className = (0, l.classnamesConvertMeToStylexPlease)(t.className, "o9gm23b4 g2xi8p6r lak21jic ag95hn57");
                    t.textContent = "•";
                    t.dataset[a.PLAIN_TEXT_DATA_ATTR] = "*";
                    return t;
                }
                updateDOM(e, t) {
                    t.textContent = "•";
        ...
        699306: (e, t, n) => {
            ...
            class i extends r.TextNode {
                ...
                static importJSON() {
                    throw (0, a.default)("Deserialization of ListNumberNode is unsupported");
                }
                createDOM(e) {
                    const t = super.createDOM(e);
                    t.className = (0, l.classnamesConvertMeToStylexPlease)(t.className, "g33ro0j9 ag95hn57");
                    return t;
                }
                exportJSON() {
                    throw (0, a.default)("Serialization of ListNumberNode is unsupported");
                }
            }
        ...
        331853: (e, t, n) => {
            ...
            class c extends r.TextNode {
                ...
                createDOM(e) {
                    const t = super.createDOM(e);
                    t.className = (0, l.classnamesConvertMeToStylexPlease)(t.className, "o0rubyzf");
                    t.dataset[a.APP_TEXT_TEMPLATE_DATA_ATTR] = `${i.ZWS}${this.wid}${i.ZWS}`;
                    return t;
                }
                getNodeMetadata() {
        ...
        347572: (e, t, n) => {
            ...
            class s extends r.TextNode {
                ...
                createDOM(e) {
                    const t = super.createDOM(e);
                    t.className = (0, l.classnamesConvertMeToStylexPlease)(t.className, "qdx05og3 tfi3kv3m r5hqxq7o tatwgjk8 nnqp5cjw skc759kk l802hdyd flcm9zni jiaumjzp ckfn5qle izle6v5g");
                    t.textContent = "　";
                    t.dataset[a.PLAIN_TEXT_DATA_ATTR] = ">";
                    return t;
                }
            ...
            t.CharacterLimitPlugin = function (e) {
                ...
                (0, s.useEffect)(() => {
                    ...
                    return m.registerUpdateListener(() => {
                        ...
                        if (r !== e.read(i.$rootTextContent) && (c != null && d(r) > c || n != null && (0, l.numCodepoints)(r) > n)) {
                            m.setEditorState(e, {
                                tag: "history-merge"
                            });
                ...
                (0, u.useLexicalCommandListener)(m, a.PASTE_TEXT_COMMAND, e => {
                    ...
                    const a = n != null && (0, l.numCodepoints)(t) - (0, l.numCodepoints)(o) + (0, l.numCodepoints)(e) > n;
                    const s = r || a;
                    if (s) {
                        if (!(f == null)) {
                            f();
        ...
        683602: (e, t, n) => {
            ...
            t.ClipboardPlugin = function (e) {
                                    ...
                                    const o = function () {
                                        if (!N) {
                                            N = (0, l.createEditor)({
                                                ...
                                                onError: () => {},
                                                nodes: [c.HeadingNode, d.ListNode, d.ListItemNode, c.QuoteNode, a.CodeNode, u.AutoLinkNode, u.LinkNode]
                                            });
                                        }
                                        return N;
                                    }();
                                    o.update(() => {
                                        ...
                                        for (; e.length;) {
                                            ...
                                            if (y(t)) {
                                                ...
                                                if ((0, l.$isParagraphNode)(t)) {
                                                    n.push(b(t.getChildren()));
                                                    n.push("");
                ...
                (0, h.useLexicalCommandListener)(M, l.CUT_COMMAND, e => e instanceof ClipboardEvent && (e.preventDefault(), e.stopPropagation(), function (e) {
                    const {
                        currentTarget: t,
                        clipboardData: n
                    } = e;
                ...
                (0, h.useLexicalCommandListener)(M, l.PASTE_COMMAND, e => {
                    O(e);
                    return true;
                });
            ...
            function y (e) {
                return (0, l.$isParagraphNode)(e) || (0, c.$isHeadingNode)(e) || (0, c.$isQuoteNode)(e) || (0, d.$isListNode)(e);
            }
        },
        768906: (e, t, n) => {
            "use strict";
            ...
            t.DebugPanelPlugin = function (e) {
                ...
                const [n] = (0, l.useLexicalComposerContext)();
                ...
                const {
                    ...
                    const [s] = (0, m.useTimeout)(() => {
                        ...
                        const l = Math.round(r / e.last.length * 100) / 100;
                        n({
                            last: l,
                            avg: o
                        });
                ...
                if (!A) {
                    ...
                    }, d.default.createElement(a.TreeView, {
                        editor: n,
                        viewClassName: (0, c.default)(S),
                        timeTravelPanelClassName: (0, c.default)(b),
                        timeTravelPanelSliderClassName: (0, c.default)(y),
                        timeTravelPanelButtonClassName: (0, c.default)(v),
        ...
        321245: (e, t, n) => {
            ...
            t.EditorStatePlugin = function (e) {
                ...
                const [c] = (0, l.useLexicalComposerContext)();
                const f = (0, i.useRef)();
                                    ...
                                    if ((0, r.$isElementNode)(i)) {
                                        ...
                                        for (const n of d(i)) {
                                            if (n instanceof a.MentionNode) {
                                                ...
                                                t.data.groupMentions = (l = t.data.groupMentions) !== null && l !== undefined ? l : [];
                                                const {
                                                    type: i,
                                                    wid: u,
                                                    name: d
                                                ...
                                                switch (i) {
                                                    case a.MentionTypeEnum.CONTACT:
                                                        t.data.mentionedJidList.push(o.wid);
                                                        break;
                                                    case a.MentionTypeEnum.GROUP:
        ...
        687112: (e, t, n) => {
                    ...
                    const e = n.registerNodeTransform(o.TextNode, e => {
                        ! function (e, t) {
                            ...
                            for (const {
                                ...
                                of
                                function* (e) {
                                    const t = l.EmojiUtil.emojiRegex();
                                    let n = 0;
                                    for (;;) {
                                        const o = t.exec(e);
                                        if (!o) {
                                ...
                                let s;
                                if (n === 0) {
                                    [l, s] = o.splitText(e.length);
                                } else {
                                    [, l, s] = o.splitText(n, n + e.length);
                                }
                                o = s;
                                const u = (0, a.$createEmojiNode)(e, null, t);
                                l.replace(u);
                            }
                        }(e, t);
                    });
                    const r = n.registerNodeTransform(o.TextNode, e => {
                        ! function (e, t) {
                            ...
                            for (let e = 2; e <= 3; e++) {
                                ...
                                const t = l.EmojiUtil.getSkinToneBase(m) && i.EmojiVariantCollection.getVariant(m);
                                m = t != null ? t : m;
                                break;
                            }
                            if (!f || !m) {
                            ...
                            const E = (0, a.$createEmojiNode)(m, f, t);
                            p.replace(E);
                        }(e, t);
                    });
                    return () => {
                ...
                (0, d.useEffect)(() => {
                    n.update(() => {
                        ...
                        for (const t of (0, u.textNodesIterator)((0, o.$getRoot)())) {
                            if ((0, a.$isEmojiNode)(t)) {
                                e.push(t);
                            }
                        }
                        e.forEach(e => {
                            e.replace((0, a.$createEmojiNode)(e.emoji(), e.textEmoji(), t));
                        });
                    });
                }, [n, t]);
            ...
            const b = String.fromCodePoint(128513);
            const v = String.fromCodePoint(128518);
            const y = {
                "(y)": f,
                "(Y)": f,
                "(n)": m,
        ...
        270916: (e, t, n) => {
            ...
            t.MentionsPlugin = function (e) {
                ...
                const [o] = (0, l.useLexicalComposerContext)();
                (0, T.useEffect)(() => {
                        ...
                        ! function (e, t, n) {
                            ...
                            for (const {
                                ...
                                function (e, t) {
                                    ...
                                    const i = Array.from(l).map(e => ({
                                        match: e,
                                        type: h.MentionTypeEnum.CONTACT
                                    }));
                                    const u = Array.from((n = a) !== null && n !== undefined ? n : []).map(e => ({
                                        match: e,
                                ...
                                if (E === h.MentionTypeEnum.CONTACT) {
                                    ...
                                    if (o != null) {
                                        if (!(0, d.getIsMe)(o) && N(t, e) || n) {
                                            ...
                                            const n = (0, h.$createMentionNode)(b(o, t), e, h.MentionTypeEnum.CONTACT);
                                            s.replace(n);
                                            g = n;
                                        } else {
                                            g = new r.TextNode(`@${b(o)}`);
                                            s.replace(g);
                                        }
                                    }
                                }
                    ...
                    const l = o.registerNodeTransform(h.MentionNode, e => {
                        ! function (e) {
                            ...
                            const l = r.startsWith(o) && n === r.length;
                            const a = r.endsWith(o) && n === r.length - o.length;
                            if (l) {
            ...
            function N (e, t) {
                ...
                const l = (n = (e == null ? undefined : e.isLidAddressingMode) === true ? (o = (0, i.getCurrentLid)(r)) === null || o === undefined ? undefined : o.toString() : t) !== null && n !== undefined ? n : t;
                return (e == null ? undefined : e.participants.get(l)) != null;
            }
            ...
            function b (e, t) {
                ...
                if ((0, E.isDropLastNameEnabled)() && (t == null ? undefined : t.hasUniqueShortNameMention(e))) {
                    ...
                    const t = (0, a.getABPropConfigValue)("elevated_push_names_v2_m2_enabled") ? "~" : "";
            ...
            t.MultilinePlugin = function (e) {
                ...
                const s = () => {
                    if (t) {
                        n.update(() => {
                            var e;
                            if (!((e = (0, l.$getRangeSelection)()) === null || e === undefined)) {
                                e.insertParagraph();
                            }
                            n.dispatchCommand(i);
                        });
                ...
                (0, a.useLexicalCommandListener)(n, o.INSERT_LINE_BREAK_COMMAND, s);
                (0, a.useLexicalCommandListener)(n, o.INSERT_PARAGRAPH_COMMAND, s);
                return null;
            };
        ...
        91922: (e, t, n) => {
            ...
            t.OnEnterPlugin = function (e) {
                ...
                const [n] = (0, r.useLexicalComposerContext)();
                (0, l.useLexicalCommandListener)(n, o.KEY_ENTER_COMMAND, e => !(!e || e.ctrlKey || e.altKey || e.shiftKey) && (t == null || t(e), true), o.COMMAND_PRIORITY_NORMAL);
                return null;
            };
            var o = n(14544);
            var r = n(71671);
        ...
        381269: (e, t, n) => {
            ...
            t.TextModifierPlugin = function (e) {
                ...
                (0, i.useLexicalCommandListener)(u, a.NEW_PARAGRAPH_COMMAND, () => {
                    if (t) {
                        (function () {
                            const e = (0, l.$getSelectionParagraph)();
                            if (!e) {
                                return;
                            }
            ...
            function s (e) {
                const t = (0, l.assertTextNode)(e.getBulletNode() || e.getNumberNode());
                ...
                static onMutator(e, t, n) {
                    const {
                        ...
                        switch (e) {
                            ...
                            case l.Strikethrough:
                                return {
                                    format: s.Strikethrough,
                                        symbol: "~"
                                };
                            case l.BulletedListItemWithEmpty:
                                return {
                                    format: s.BulletedListItem,
                                        symbol: "*"
                                };
                            case l.HyphenListItemWithEmpty:
                                return {
                                    format: s.HyphenListItem,
                                        symbol: "-"
                                };
                            case l.NumberedListItemWithEmpty:
                                return {
            ...
            const f = e => {
                ...
                return [
                    [
                        ...
                        [l.BulletedListItemWithEmpty, {}]
                    ] : null, t ? [
                        [l.HyphenListItemWithEmpty, {}]
                    ] : null, n ? [
                        [l.NumberedListItemWithEmpty, {}]
                    ] : null, r ? [
                        [l.BlockQuoteWithEmpty, {}]
                    ] : null, o ? [
                        [l.InlineCode, {}]
                    ] : null, [
                        [l.Bold, {}],
        ...
        862180: (e, t, n) => {
            ...
            t.TextFormatPreviewPlugin = function (e) {
                ...
                const [s] = (0, l.useLexicalComposerContext)();
                (0, p.useEffect)(() => {
                    let e = false;
            ...
            function C (e, t) {
                ...
                for (; o.getTextContentSize() < t.length;) {
                    const [e] = (0, a.default)(g(o), "$getNextTextNode(symbolNode)").splitText(0, t.length - o.getTextContentSize());
                    ...
                    for (const o of t) {
                        switch (o) {
                            ...
                            case m.FormatType.InlineCode:
                                e.toggleFormat("code");
                                v(e, "color: var(--inline-code-text);", "border-radius: 6px;", "background-color: var(--inline-code-background);", "padding: 0 4px;");
                                break;
                            case m.FormatType.BlockQuote:
                                if (!(n || (0, c.$isMentionNode)(e))) {
                                    v(e, "color: var(--block-quote-text);");
                                }
                                break;
                            case m.FormatType.BotCommand:
                                v(e, "color: var(--bot-command-text);");
                                break;
                ...
                (0, u.useLexicalCommandListener)(e, r.KEY_MODIFIER_COMMAND, t => {
                    ...
                    return !(!n || e.isComposing()) && (e.update(() => {
                        ! function (e) {
                            ...
                            const l = (0, s.assertTextNode)(n.at(-1));
                                    ...
                                    n.forEach(e => {
                                        if ((0, r.$isTextNode)(e) && (["Bold", "Italic", "Strikethrough"].forEach(t => {
                                                if (e.hasFormat(t.toLowerCase())) {
                                                    o.push((0, a.default)(d.cast(t), "TextFormatType.cast(format)"));
                                                }
                                            }), e.hasFormat("code"))) {
                            ...
                            if (u === c.Remove) {
                                ...
                                if (!(0, i.$isDelimiterNode)(e)) {
                                    e = (0, a.default)(e.getPreviousSibling(), "openingDelimiter.getPreviousSibling<DelimiterNode>()");
                                }
                                if (!(0, i.$isDelimiterNode)(t)) {
                                    t = (0, a.default)(t.getNextSibling(), "closingDelimiter.getNextSibling<DelimiterNode>()");
                                }
                                e.remove();
                                t.remove();
                            } else {
                                ...
                                const a = `${n}${t.getTextContent()}${n}`;
                                const i = (0, r.$createTextNode)(a);
                                const s = [i];
                                const u = e === d.Code;
                                ...
                                const p = (m = l.getNextSibling()) === null || m === undefined ? undefined : m.getTextContent();
            ...
            function f (e, t) {
                ...
                if (n) {
                    return s.default.createElement(i.HotKeys, {
                        ...
                        onFocus: m,
                        xstyle: h
                    }, s.default.createElement(a.ListSearch, (0, r.default)({
                        ref: t,
                        onSearch: g,
                        onEnter: c,
                        type: p
        ...
        238608: (e, t, n) => {
            ...
            t.BackIcon = function (e) {
                ...
                return s.default.createElement(a.BaseSvgSpan, (0, r.default)({
                    name: "back"
...
//# sourceMappingURL=https://web.whatsapp.com/main~.7ddec27ec36f8a61fd89.js.map